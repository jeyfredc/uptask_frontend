...
export default function ProjectTeamView() {
  ...
  const { mutate } = useMutation({
    ...
    onSuccess: (data) => {
      /* Asi es como se invalida un query lo que hace es volver a recargar la pagina como un refetch al api para cargar los datos que existan */
